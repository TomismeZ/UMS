 ...
 * Generated at: 2017-10-31 09:28:46 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\tvar userName = $form1.find(\"input[type='text']\").val();\r\n");
      out.write("\t\t\t\tvar password = $form1.find(\"input[name='account.password']\").val();\r\n");
      out.write("\t\t\t\tvar passwordAgain=$form1.find(\"input[name='account.passwordAgain']\").val();\r\n");
