 ...
 * Generated at: 2017-10-23 03:19:16 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t$form = $registContent.find(\"form\");\r\n");
      out.write("\t\t\t\tvar userName = $form.find(\"input[type='text']\").val();\r\n");
      out.write("\t\t\t\tvar password = $form.find(\"input[name='account.password']\").val();\r\n");
      out.write("\t\t\t\tvar passwordAgain=$form.find(\"input[name='account.passwordAgain']\").val();\r\n");
      out.write("\t\t\t\tvar id=$form.find(\"input[type='hidden']\").val();\r\n");
      out.write("\t\t\t\tif(id == 1){\r\n");
      out.write("\t\t\t\t\tif (!$.trim(userName) || !$.trim(password) || !$.trim(passwordAgain)) {\r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/register.jsp(6,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fwhen_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\ttype=\"password\" name=\"account.password\"></label>\r\n");
          out.write("\t\t\t\t\t</section>\r\n");
          out.write("\t\t\t\t\t<section>\r\n");
          out.write("\t\t\t\t\t\t<label class=\"lable\">确认密码</label> <label class=\"input\"><input\r\n");
          out.write("\t\t\t\t\t\t\ttype=\"password\" name=\"account.passwordAgain\"></label>\r\n");
          out.write("\t\t\t\t\t</section>\r\n");
          out.write("\t\t\t\t</div>\r\n");
          out.write("\t\t\t</form>\r\n");
