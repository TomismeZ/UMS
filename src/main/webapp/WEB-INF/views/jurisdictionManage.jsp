...
<div class="jurisdiction-manage">
	...
	<div class="footer">
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="findAllJurisdiction">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="findAllJurisdiction"
		...
		<c:choose>
			<c:when test="${pageBean.currentPage != pageBean.totalPage }">
				<a href="findAllJurisdiction" data-page="${pageBean.currentPage + 1 }">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="findAllJurisdiction" data-page="${pageBean.totalPage }">尾页</a>
			</c:when>
			<c:otherwise>
			下一页&nbsp;&nbsp;&nbsp;尾页
			</c:otherwise>
